...
document.querySelector("#cards").innerHTML =
  ...
  createCard(
    ...
    createGame("cameroon", "07:00", "switzerland") +
      createGame("southkorean", "10:00", "uruguay") +
  ...
  createCard(
    "26/11",
    "sabado",
    createGame("tunisia", "16:00", "australia") +
      createGame("saudiarabia", "10:00", "poland") +
  ...
  createCard(
    "28/11",
    "segunda",
    createGame("cameroon", "07:00", "serbian") +
      createGame("southkorean", "10:00", "ghana") +
  ...
  createCard(
    ...
    createGame("croatia", "07:00", "belgium") +
      createGame("morocco", "10:00", "canada") +
  ...
  createCard(
    "02/12",
    "sexta",
    createGame("southkorean", "07:00", "portugal") +
      createGame("ghana", "10:00", "uruguay") +
      createGame("serbian", "13:00", "switzerland") +
